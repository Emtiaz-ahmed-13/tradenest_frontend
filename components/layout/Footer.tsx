      ...
      <div className="mx-auto grid max-w-7xl gap-8 px-4 py-10 sm:px-6 md:grid-cols-[1.4fr_1fr_1fr_1fr] lg:px-8">
        ...
        <div>
          ...
          <div className="grid gap-2 text-sm text-gray-500">
            ...
            <Link href="/flash-sales" className="hover:text-brand-600">Flash sales</Link>
        ...
        <div>
          ...
          <div className="grid gap-2 text-sm text-gray-500">
            ...
            <Link href="/referrals" className="hover:text-brand-600">Referrals</Link>
            <Link href="/kyc" className="hover:text-brand-600">KYC</Link>
            <Link href="/swap" className="hover:text-brand-600">Swap</Link>
          </div>
        </div>

        <div>
          <h3 className="mb-3 text-sm font-semibold text-gray-900">Workspace</h3>
          <div className="grid gap-2 text-sm text-gray-500">
